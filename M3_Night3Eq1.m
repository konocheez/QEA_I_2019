...
vx = linspeed.*cos(theta);
vy = linspeed.*sin(theta);

figure;
xpos = cumsum(vx.*[diff(time); 0]);
...
% plot(r(1, :), r(2, :))
% quiver(r(1, :), r(2, :), velocity(1, :), velocity(2, :))
quiver(r(1, 1:4:end), r(2, 1:4:end), velocity(1, 1:4:end), velocity(2, 1:4:end), '--r')
